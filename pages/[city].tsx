...
export default function City({city, data}: any){
   return(
      <div className="bg-gradient-to-t from-sky-300 via-sky-300 to-sky-400 fixed bg-cover h-screen w-full p-4 pt-6 flex flex-col">
         <Head>
            <title>{city.name}</title>
            <meta name="description" content="Generated by create next app" />
            <link rel="icon" href="/favicon.ico" />
         </Head>
         <main className="h-screen w-full flex flex-col items-center gap-4 md:gap-10">
